%%
%% This is file `research_schedule.tex',
%%
...
Add a simple figure, Figure~\ref{fig:fig10}, to illustrate
...
\lipsum[13].  Figure~\ref{fig:fig01rs} illustrates the use
...
\begin{figure}[tb]
  ...
  \caption[A figure caption which is extra long.]{A figure caption
    which is extra long. This long caption not only demonstrates that
...
Finally the tables, Table~\ref{tbl:tbl01rs} illustrates the syntax of a
basic table. %
\begin{table}[tb]
...
Table~\ref{tbl:tbl02rs}, which illustrates the syntax of a three-part
...
\endinput
%%
%% End of file `research_schedule.tex'.
